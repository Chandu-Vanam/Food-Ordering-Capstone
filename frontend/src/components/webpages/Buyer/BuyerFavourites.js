...
const BuyerFavourites = () => {
    ...
    const handleFavouriteRemove = item => {
        ...
        axios
            .patch(`http://localhost:8000/api/buyers/remove_favourite`, {
                item_id: item._id
            }, {
                headers: {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response_1 = await axios.get('http://localhost:8000/api/items', {
                headers: {
                    authorization: localStorage.getItem("token"),
                },
            });
            const response_2 = await axios.get('http://localhost:8000/api/buyers/details', {
                headers: {
                    authorization: localStorage.getItem("token"),
                },
            });
            const response_3 = await axios.get('http://localhost:8000/api/vendors', {
                headers: {
                    authorization: localStorage.getItem("token"),
                },
            });
